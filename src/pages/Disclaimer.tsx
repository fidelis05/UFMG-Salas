    ...
    <div className="max-w-3xl mx-auto p-4 md:p-8">
      <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 space-y-5">
        ...
        <p className="text-gray-600">
          ...
          Federal de Minas Gerais (UFMG). Nomes e marcas da UFMG aparecem
          aqui apenas para fins de identificação e referência.
        </p>
        ...
        <p className="text-gray-600">
          ...
          horários do próprio usuário, obtida diretamente dos sistemas
          oficiais da universidade mediante login do estudante.
        </p>
        ...
        <p className="text-gray-600">
          ...
          credenciais em nenhum momento. Apenas o token de sessão retornado
          pela universidade é mantido para manter você conectado.
        </p>
        ...
        <p className="text-gray-600">
          ...
          Não nos responsabilizamos por danos, prejuízos ou transtornos
          decorrentes de informações desatualizadas, indisponibilidade do
          serviço ou uso indevido dos dados aqui apresentados.
        </p>
      </div>
    </div>
  );
